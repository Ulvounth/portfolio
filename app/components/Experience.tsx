        ...
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            ...
            <p>
              ...
              These studies will focus on back-end technologies, server-side
        ...
        <li>
          ...
          <div className="timeline-end mb-10">
            ...
            <p>
              ...
              thorough knowledge of HTML, CSS, JavaScript, React, TypeScript and
              Next.js. Gained expertise in building advanced web applications
              using CSS frameworks like Bootstrap and Tailwind, along with tools
